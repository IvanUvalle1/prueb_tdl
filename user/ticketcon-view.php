  ...
  if(MysqlQuery::Eliminar("ticket", "serie='$id'")){
    echo '
        <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
            ...
            <h4 class="text-center">TAREA ELIMINADO</h4>
            <p class="text-center">
    ...
    echo '
        <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
            ...
            <p class="text-center">
                Lo sentimos, no hemos podido eliminar la tarea
            </p>
        </div>
    ';
  }
...
?>
        <div class="container">
            ...
            <div class="col-sm-10 lead text-justify">
              <h2 class="text-info">Estado de Tarea</h2>
              <p>Si su <strong>tarea</strong> no ha sido terminada aún, espere pacientemente</p>
            </div>
          </div><!--fin row well-->
          <div class="row">
              <div class="col-sm-12">
                    <div class="panel panel-success">
                        <div class="panel-heading text-center"><h4><i class="fa fa-ticket"></i> Tarea &nbsp;#<?php echo $lsT['serie']; ?></h4></div>
                              ...
                              <div class="col-sm-12">
                                  <div class="row">
                                      ...
                                      <div class="col-sm-8">
                                          ...
                                          <br>
                                          <div class="row">
                                              <div class="col-sm-6"><strong>Avance:</strong> <?php echo $lsT['avance']; ?></div>
        ...
        <div class="container">
            <div class="row  animated fadeInDownBig">
                ...
                <div class="col-sm-7 text-center">
                    ...
                    <h3 class="text-warning"><i class="fa fa-check"></i> La tarea ha sido eliminada completamente.</h3>
                    <h3 class="text-warning"><i class="fa fa-check"></i> Los datos ingresados no son correctos.</h3>
                    <br>
                    <h3 class="text-primary"> Por favor verifique que su <strong>id tarea</strong> y <strong>email</strong> sean correctos, e intente nuevamente.</h3>
